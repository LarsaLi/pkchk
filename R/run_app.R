    ...
    shinydashboard::dashboardBody(
      shiny::tags$head(
        shiny::tags$style(shiny::HTML(paste(
          "body{font-family:Inter,-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#1f2937;}",
          ".main-header .logo{font-weight:700;letter-spacing:.2px;background:#f7fafc !important;color:#1f2937 !important;border-bottom:1px solid #e7edf3;}",
          ".main-header .navbar{background:#f7fafc !important;border-bottom:1px solid #e7edf3;}",
          ".main-header .sidebar-toggle{color:#334155 !important;}",
          ".main-sidebar{background:#f8fbfd !important;border-right:1px solid #e7edf3;}",
          ".sidebar-menu>li>a{padding-top:12px;padding-bottom:12px;color:#1f2937 !important;font-weight:600;}",
          ".sidebar-menu>li.active>a,.sidebar-menu>li:hover>a{border-left-color:#6b8fa3 !important;background:#e9f1f6 !important;color:#0f2f3f !important;}",
          ...
          ".box.box-primary>.box-header{background:#f2f7fb;color:#1f2937;border-top-left-radius:14px;border-top-right-radius:14px;border-bottom:1px solid #e7edf3;font-weight:700;}",
          ".box.box-info>.box-header{background:#f2f8fa;color:#1f2937;border-top-left-radius:14px;border-top-right-radius:14px;border-bottom:1px solid #e7edf3;font-weight:700;}",
          ".box.box-success>.box-header{background:#f2faf6;color:#1f2937;border-top-left-radius:14px;border-top-right-radius:14px;border-bottom:1px solid #e7edf3;font-weight:700;}",
          ".box.box-warning>.box-header{background:#fcf8f1;color:#1f2937;border-top-left-radius:14px;border-top-right-radius:14px;border-bottom:1px solid #e7edf3;font-weight:700;}",
          ...
          ".small-box.bg-aqua{background:#d9ecf5 !important;color:#1f2937 !important;}",
          ".small-box.bg-green{background:#e3f1e8 !important;color:#1f2937 !important;}",
          ".small-box.bg-yellow{background:#f6efdd !important;color:#1f2937 !important;}",
          ".small-box.bg-purple{background:#ece6f7 !important;color:#1f2937 !important;}",
          ...
          ".dataTables_wrapper .dataTables_filter input,.dataTables_wrapper .dataTables_length select{border-radius:8px;border:1px solid #d5dee7;background:#fff;}.table, .dataTable, .dataTables_wrapper{color:#1f2937 !important;} .dataTables_wrapper .dataTables_info,.dataTables_wrapper .dataTables_paginate{color:#374151 !important;}",
          sep=""
        )))
      ),
