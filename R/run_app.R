    ...
    shinydashboard::dashboardBody(
      shiny::tags$head(
        shiny::tags$style(shiny::HTML(paste(
          "body{font-family:Inter,-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#334155;}",
          ".main-header .logo{font-weight:700;letter-spacing:.2px;background:#f7fafc !important;color:#334155 !important;border-bottom:1px solid #e7edf3;}",
          ".main-header .navbar{background:#f7fafc !important;border-bottom:1px solid #e7edf3;}",
          ".main-header .sidebar-toggle{color:#64748b !important;}",
          ".main-sidebar{background:#f8fbfd !important;border-right:1px solid #e7edf3;}",
          ".sidebar-menu>li>a{padding-top:12px;padding-bottom:12px;color:#475569 !important;}",
          ".sidebar-menu>li.active>a,.sidebar-menu>li:hover>a{border-left-color:#9fbecf !important;background:#eef5f9 !important;color:#1f3b4d !important;}",
          ...
          ".box.box-primary>.box-header{background:#f2f7fb;color:#355063;border-top-left-radius:14px;border-top-right-radius:14px;border-bottom:1px solid #e7edf3;}",
          ".box.box-info>.box-header{background:#f2f8fa;color:#335e73;border-top-left-radius:14px;border-top-right-radius:14px;border-bottom:1px solid #e7edf3;}",
          ".box.box-success>.box-header{background:#f2faf6;color:#345a45;border-top-left-radius:14px;border-top-right-radius:14px;border-bottom:1px solid #e7edf3;}",
          ".box.box-warning>.box-header{background:#fcf8f1;color:#6b5a3d;border-top-left-radius:14px;border-top-right-radius:14px;border-bottom:1px solid #e7edf3;}",
          ...
          ".small-box.bg-aqua{background:#d9ecf5 !important;color:#325369 !important;}",
          ".small-box.bg-green{background:#e3f1e8 !important;color:#375b49 !important;}",
          ".small-box.bg-yellow{background:#f6efdd !important;color:#6a5b3a !important;}",
          ".small-box.bg-purple{background:#ece6f7 !important;color:#54426f !important;}",
          ".small-box>.inner{padding:14px 12px;}",
          ".small-box h3{font-size:28px;font-weight:700;}",
          ".small-box p{font-size:13px;}",
          ".small-box .icon{color:rgba(51,65,85,.18) !important;}",
          ".dataTables_wrapper .dataTables_filter input,.dataTables_wrapper .dataTables_length select{border-radius:8px;border:1px solid #d5dee7;background:#fff;}",
          sep=""
        )))
      ),
